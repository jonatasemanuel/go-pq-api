...
// 	connectionString := fmt.Sprintf("user=%s password=%s dbname=%s sslmode=enable", user, password, dbname)

func (a *App) Initialize() {
	connectionString := "user=postgres password=pass dbname=postgres sslmode=disable"
